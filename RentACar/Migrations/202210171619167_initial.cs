namespace RentACar.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PlateNumber = c.String(nullable: false, maxLength: 25),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CarRentals", "ApplicationUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.CarRentals", new[] { "ApplicationUserId" });
